...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'utto', // 您的昵称 例如 tangly1024
  BIO:
    process.env.NEXT_PUBLIC_BIO || '爱玩、爱学、爱竞技，也认真记录成长', // 作者简介
  LINK:
  ...
  CUSTOM_EXTERNAL_CSS: [''], // e.g. ['http://xx.com/style.css','http://xx.com/script.js']
  ...
  GREETING_WORDS:
    ...
    '你好，我是 utto,记录学习与游戏开发,欢迎来到 utto 的学习屋',
