  ...
  return (
    <div className='w-full md:pr-8 mb-12 px-5'>
      <div id='posts-wrapper'>
        {posts?.map((p, index) => (
          <div key={p.id}>
            {CLAUDE_POST_AD_ENABLE && (index + 1) % 3 === 0 && (
      ...
      <div className='flex justify-between text-xs mt-1'>
        <SmartLink
          ...
          className={`${showPrev ? 'text-blue-600 border-b border-blue-400 dark:text-white dark:border-white visible ' : ' invisible bg-gray pointer-events-none '} no-underline pb-1 px-3`}>
        ...
        <SmartLink
          ...
          className={`${showNext ? 'text-blue-600 border-b border-blue-400 dark:text-white dark:border-white visible' : ' invisible bg-gray pointer-events-none '} no-underline pb-1 px-3`}>
